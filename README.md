...
- Phase 2 in progress: RSS and WebSocket monitors implemented with parity patch robustness.
- Remaining phases (planned): TUI, state persistence, notifications, Email monitor, Website monitor.
